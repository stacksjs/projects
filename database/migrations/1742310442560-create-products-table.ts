...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('manufacturer_id', 'integer', col => col.references('manufacturers.id').onDelete('cascade'))
    .addColumn('product_category_id', 'integer', col => col.references('product_categories.id').onDelete('cascade'))
