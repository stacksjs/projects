 ...
 *      `route.register(...)` on import — the Stacks analogue of a
 *      Laravel service provider's `boot()` method. This is the preferred
 *      shape for packages that own their own routes/migrations/etc.
 *
