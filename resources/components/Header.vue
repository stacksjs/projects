...
const isDarkMode = useLocalStorage('isDarkMode', true) // Store in localStorage with default to dark mode
  ...
  <aside :class="[
    ...
    <nav class="flex-grow flex flex-col justify-center font-mono">
      ...
      <div class="mt-12 flex flex-col space-y-3">
        ...
        <a
          href="https://www.linkedin.com/in/chrisbbreuer/"
          target="_blank"
          rel="noopener"
          :class="[
            'transition-colors duration-200',
        ...
        <a
          href="https://bsky.app/profile/chrisbreuer.com"
          target="_blank"
          rel="noopener"
          :class="[
            'transition-colors duration-200',
